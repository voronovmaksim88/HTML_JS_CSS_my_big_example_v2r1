...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const constNum = 123;
    document.getElementById('Div_Const').innerHTML += ('<p>' + constNum + '</p>');
    ...
    document.getElementById('Div_Const').innerHTML += ('<p>' + constStr + '</p>');
    ...
    Div_object1.innerHTML += ('object1.property1 = ' + object1.property1 + "<br/>")
    Div_object1.innerHTML += ('object1.property2 = ' + object1.property2 + "<br/>")


    // ВЫРАЖЕНИЯ
    let div_expression = document.getElementById('div_expression');
    div_expression.innerHTML += ("<h3>" + "ВЫРАЖЕНИЯ" + "</h3>")
    div_expression.innerHTML += ("<b>" + "Выражение" + "</b>" +
        " (expression) в JavaScript - это комбинация значений," +
        " переменных, операторов и вызовов функций, которая вычисляется в значение." + "<br/>" +
    ...
    div_expression.innerHTML += ("constNum1 = " + (constNum1 = 123) + ", точно " + constNum1 + "<br/>")
    ...
    div_expression.innerHTML += ("Функция без return возвращает " + "<b>" + myFunction() + "</b>")
    ...
    div_object3.innerHTML += ('создаём свойство объекта с именем как у переменной' + "<br/>")
    const propertyName = "property3"
    objectA[propertyName] = "value3"
    div_object3.innerHTML += (JSON.stringify(objectA) + "<br/>") // про JSON далее будет
    div_object3.innerHTML += ("<br/>" + 'добавляем свойства к копии объекта, ' + "<br/>")
    div_object3.innerHTML += ('исходный объект тоже получает эти свойства, ' + "<br/>")
    div_object3.innerHTML += ('объект и его копия это ссылки на одну и ту же область памяти')
...
function but_change_str() {
    ...
    let div_no_dynamic_typing = document.getElementById('div_no_dynamic_typing');
    div_no_dynamic_typing.innerHTML += "<p style='color: darkred'> Ошибка: Значение не является числом </p> "
}
